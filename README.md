...
- 🐛 **PyInstaller 构建修复** — VERSION 文件打包进 exe，修复冻结模式下 `FileNotFoundError`
- 🔍 **检查更新弹窗精简** — 移除更新日志显示

**v1.0.2**：检查更新、UI 精简、扫码登录改用 `x/web-interface/card`。

**v1.0.1**：弹幕过滤、荣耀等级欢迎、数据保留策略、数据管理拆分、弹窗优化、Bug 修复、新建房间自动查询用户名。
